(function (window) {
    ...
    platform.init = function (game) {
         ...
         * bottom of the game.
         */
        platform.create(0, game.world.height - 32, 12, 8);

        // example:
        platform.create(240, 555);
        platform.create(360, 444);
        platform.create(420, 333);
        platform.create(580, 222);
        platform.create(50, 111);
